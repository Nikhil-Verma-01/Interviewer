...
const Agent = ({userName, userId, type, interviewId, questions}: AgentProps) => {
    ...
    useEffect(() => {
        ...
        //When componenst are unmounted, we returning vapi off
        //**It doesn't slow our application if we not using it. */
        return () => {
            ...
            {messages.length > 0 && (
                <div className='transcript-border'>
                    <div className='transcript'>
                        ...
                        ('transition-opacity duration-500 opacity-0', 'animate-fadeIn opacity-10')}>
                            {lastestMessage}
                        </p>
                    </div>
                </div>
